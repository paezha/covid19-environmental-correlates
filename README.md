...
<a href="https://www.codecogs.com/eqnedit.php?latex=\begin{equation}&space;\label{eq:sur-sim}&space;\begin{bmatrix}&space;y_1&space;\\&space;y_2&space;\\&space;\vdots&space;\\&space;y_T&space;\end{bmatrix}&space;=&space;\begin{bmatrix}&space;X_1&space;&&space;0&space;&&space;\cdots&space;&&space;0&space;\\&space;0&space;&&space;X_2&space;&&space;\cdots&space;&&space;0&space;\\&space;\vdots&space;&&space;\vdots&space;&&space;\ddots&space;&&space;\vdots&space;\\&space;0&space;&&space;0&space;&&space;\cdots&space;&&space;X_T&space;\end{bmatrix}&space;\&space;\begin{bmatrix}&space;\beta_1&space;\\&space;\beta_1&space;\\&space;\vdots&space;\\&space;\beta_T&space;\end{bmatrix}&space;&plus;&space;\begin{bmatrix}&space;\epsilon_1&space;\\&space;\epsilon_2&space;\\&space;\vdots&space;\\&space;\epsilon_T&space;\end{bmatrix}&space;\end{equation}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\begin{equation}&space;\label{eq:sur-sim}&space;\begin{bmatrix}&space;y_1&space;\\&space;y_2&space;\\&space;\vdots&space;\\&space;y_T&space;\end{bmatrix}&space;=&space;\begin{bmatrix}&space;X_1&space;&&space;0&space;&&space;\cdots&space;&&space;0&space;\\&space;0&space;&&space;X_2&space;&&space;\cdots&space;&&space;0&space;\\&space;\vdots&space;&&space;\vdots&space;&&space;\ddots&space;&&space;\vdots&space;\\&space;0&space;&&space;0&space;&&space;\cdots&space;&&space;X_T&space;\end{bmatrix}&space;\&space;\begin{bmatrix}&space;\beta_1&space;\\&space;\beta_1&space;\\&space;\vdots&space;\\&space;\beta_T&space;\end{bmatrix}&space;&plus;&space;\begin{bmatrix}&space;\epsilon_1&space;\\&space;\epsilon_2&space;\\&space;\vdots&space;\\&space;\epsilon_T&space;\end{bmatrix}&space;\end{equation}" title="\begin{equation} \label{eq:sur-sim} \begin{bmatrix} y_1 \\ y_2 \\ \vdots \\ y_T \end{bmatrix} = \begin{bmatrix} X_1 & 0 & \cdots & 0 \\ 0 & X_2 & \cdots & 0 \\ \vdots & \vdots & \ddots & \vdots \\ 0 & 0 & \cdots & X_T \end{bmatrix} \ \begin{bmatrix} \beta_1 \\ \beta_1 \\ \vdots \\ \beta_T \end{bmatrix} + \begin{bmatrix} \epsilon_1 \\ \epsilon_2 \\ \vdots \\ \epsilon_T \end{bmatrix} \end{equation}" /></a>
