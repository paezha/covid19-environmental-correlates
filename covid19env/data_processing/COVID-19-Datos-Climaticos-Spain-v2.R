...
# List of dates
mydates <- seq(as.Date("2020/3/01"), as.Date("2020/4/04"), "day")
...
TMed <- matrix(0,nrow = 50, ncol = 35)
TMax <- matrix(0,nrow = 50, ncol = 35)
TMin <- matrix(0,nrow = 50, ncol = 35)
Plu <- matrix(0,nrow = 50, ncol = 35)
Sun <- matrix(0,nrow = 50, ncol = 35)
for (i in 1:50){
...
Hum <- cbind(1:50,provincias.sf$PROVINCIA,provincias.sf$ID_INE,Hum)
...
names(Hum) <- c("ID","provincia","ID_INE",paste0("Hum",substr(gsub("-",".",as.character(mydates)),start=5,stop=10)))
