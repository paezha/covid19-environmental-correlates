...
```{r map-controls, cache=TRUE, echo=FALSE, fig.height= 9, fig.cap="\\label{fig:map-controls}Spatial distribution of control variables by province (maps omits Islas Canarias)", cache = TRUE}
# GDP per capita:
