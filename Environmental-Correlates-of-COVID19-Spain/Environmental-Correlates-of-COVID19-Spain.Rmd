...
address:
  - code: Some School
    address: School of the Things
  - code: Some Institute
    address: Institute of Everything
...
Please note that this paper is prepared as a reproducible research document. The source R Markdown document, as well as all data and code needed to reproduce/review/extend the analysis can be obtained from the following anonymous Drive folder:
